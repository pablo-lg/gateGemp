...
@RestController
@RequestMapping("/api/gate-gemp-kafka")
public class GateGempKafkaResource {

    private final Logger log = LoggerFactory.getLogger(GateGempKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public GateGempKafkaResource(KafkaProperties kafkaProperties) {
